...
values = std_fonts.split()
line = "    dat "

for c in range(128):
    l = int(values[2*c], 16)
    r = int(values[2*c+1], 16)

    t = b = 0

    t = 1 if l & 0x0100 else 0
    t <<= 1
    t |= 1 if l & 0x0001 else 0
    t <<= 1
    t |= 1 if r & 0x0100 else 0
    t <<= 1
    t |= 1 if r & 0x0001 else 0
    t <<= 1

    t |= 1 if l & 0x0200 else 0
    t <<= 1
    t |= 1 if l & 0x0002 else 0
    t <<= 1
    t |= 1 if r & 0x0200 else 0
    t <<= 1
    t |= 1 if r & 0x0002 else 0
    t <<= 1

    t |= 1 if l & 0x0400 else 0
    t <<= 1
    t |= 1 if l & 0x0004 else 0
    t <<= 1
    t |= 1 if r & 0x0400 else 0
    t <<= 1
    t |= 1 if r & 0x0004 else 0
    t <<= 1

    t |= 1 if l & 0x0800 else 0
    t <<= 1
    t |= 1 if l & 0x0008 else 0
    t <<= 1
    t |= 1 if r & 0x0800 else 0
    t <<= 1
    t |= 1 if r & 0x0008 else 0

    b = 1 if l & 0x1000 else 0
    b <<= 1
    b |= 1 if l & 0x0010 else 0
    b <<= 1
    b |= 1 if r & 0x1000 else 0
    b <<= 1
    b |= 1 if r & 0x0010 else 0
    b <<= 1

    b |= 1 if l & 0x2000 else 0
    b <<= 1
    b |= 1 if l & 0x0020 else 0
    b <<= 1
    b |= 1 if r & 0x2000 else 0
    b <<= 1
    b |= 1 if r & 0x0020 else 0
    b <<= 1

    b |= 1 if l & 0x4000 else 0
    b <<= 1
    b |= 1 if l & 0x0040 else 0
    b <<= 1
    b |= 1 if r & 0x4000 else 0
    b <<= 1
    b |= 1 if r & 0x0040 else 0
    b <<= 1

    b |= 1 if l & 0x8000 else 0
    b <<= 1
    b |= 1 if l & 0x0080 else 0
    b <<= 1
    b |= 1 if r & 0x8000 else 0
    b <<= 1
    b |= 1 if r & 0x0080 else 0

    if c % 4 == 0:
        print line[:-1]
        line = "    dat"

    line += " 0x%.4x, 0x%.4x," % (t, b)
